---
title: "Troubleshoot Basalt Installation and Home Assistant Controls"
description:
  Solutions for common issues when installing Basalt, connecting to WiFi, or adding the device to Home Assistant.
---
...
- Use the [C6 WiFi recovery installer](/getting-started/c6-recovery) to reinstall
  Basalt and repair the C6 over USB without depending on WiFi.
...
- Open a [GitHub issue](https://github.com/infamy/basalt/issues/new) and describe the display model, firmware version, and what happened.
