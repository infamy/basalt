---
title: Install Basalt on a Home Assistant Touchscreen
titleTemplate: :title
description:
  How to flash Basalt firmware to a supported ESP32 touchscreen, connect it to WiFi, and add it to Home Assistant.
---

# Install Basalt on a Home Assistant Touchscreen

Flash the Basalt firmware to your supported ESP32 display directly from your browser — no special software or technical knowledge required.
...
2. **Choose your device and hardware version** above, then click **Install Basalt**. A dialog will ask you to choose a serial port — select the one that appeared when you plugged in the display.
