...
description:
  Use USB to reinstall Basalt and repair the ESP32-C6 WiFi processor on a supported ESP32-P4 panel without needing a network connection.
---
...
The recovery download contains both the latest Basalt firmware and its matching
...
::: warning This reinstalls Basalt
...
4. Confirm the selection, then choose **Repair C6 and reinstall Basalt**.
...
[GitHub issue](https://github.com/infamy/basalt/issues/new) before attempting
