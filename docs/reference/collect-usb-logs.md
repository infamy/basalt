...
description:
  How to collect Basalt logs over USB with the web installer and share them in a GitHub issue.
---
...
You do not need to install developer tools. You can collect the logs from the same browser-based installer used to flash Basalt.
...
2. Open the [Basalt install page](/getting-started/install).
3. Choose your panel model.
4. Click **Install Basalt**.
...
1. Open the [Basalt issues page](https://github.com/infamy/basalt/issues).
