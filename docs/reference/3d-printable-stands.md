...
description:
  3D printable stands and mounts for Basalt supported ESP32 touchscreens, with links to the matching MakerWorld print files.
---

# Printable Stands and Mounts

These printable files are optional stands and mounts for supported Basalt panels. They are useful when you want a display on a desk, shelf, bedside table, test bench, or wall.
...
- [Install Basalt](/getting-started/install)
