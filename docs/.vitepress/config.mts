...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'GitHub', link: 'https://github.com/infamy/basalt' },
    ],
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Connect to Basalt', link: '/immich/display-setup' },
    ...
    editLink: {
      pattern: 'https://github.com/infamy/basalt/edit/main/docs/:path',
      text: 'Edit this page on GitHub',
    },

    socialLinks: [{ icon: 'github', link: 'https://github.com/infamy/basalt' }],
