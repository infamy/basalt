---
title: "ESP32-P4 86 Home Assistant Setup"
description:
  Basalt on the ESP32-P4 86 - a 4-inch 720x720 square touchscreen with 9 cards, powered by ESP32-P4.
---

# 4-inch ESP32-P4 86

The **ESP32-P4 86** is a 4-inch square touchscreen powered by an **ESP32-P4** processor. It uses the same 3x3 Basalt layout as the Guition 4848S040, but with a sharper 720x720 display and a faster P4 platform.

Basalt targets the **ESP32-P4-86-Panel-ETH-2RO** model. That version includes WiFi through an ESP32-C6 co-processor, wired Ethernet hardware, and two built-in relays.
...
<C6RecoveryCallout slug="esp32-p4-86" />
...
- **AliExpress:** [~£45](https://www.aliexpress.com/item/1005009476605517.html)
