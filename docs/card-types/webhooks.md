...
description:
  How to use webhook cards on your Basalt panel to call HTTP URLs directly from the device.
---
...
If you enter a JSON-looking body and do not provide a `Content-Type` header, Basalt sends `Content-Type: application/json` automatically.
