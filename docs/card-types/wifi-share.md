...
description: Share separately configured guest Wifi with a scannable QR code on Basalt.
---
...
It does not read, reveal, or share the Wifi network used by the Basalt panel itself. You enter a separate network name and, where needed, a password.
