...
description:
  How to use media cards on your Basalt panel to control Home Assistant media players.
---
...
Add your Sonos, Spotify, Apple TV, Plex, Music Assistant, or other player integration in Home Assistant first. Basalt uses the entities and capabilities that integration exposes; it does not connect a speaker or streaming account for you.
