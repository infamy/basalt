...
description:
  How to show the current time for another city on your Basalt panel.
---
...
- The card uses the fixed **tertiary** background colour, like Sensor, Date, and Weather cards.
