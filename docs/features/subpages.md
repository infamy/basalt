...
title: Subpage Cards
description:
  How to use Subpage cards on your Basalt panel to organise cards into folders.
---
...
To copy a card to another Basalt panel:
