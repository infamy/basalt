---
title: "Basalt: No-Code Home Assistant Touchscreen"
titleTemplate: :title
...
![Basalt on a 7-inch touchscreen: home screen with temperature, clock, and control tiles](/images/home_screen_hero.jpg)

# Basalt: No-Code Home Assistant Touchscreen

**A no-code touchscreen controller for Home Assistant.** Basalt turns affordable ESP32 touchscreens into dedicated panels for the lights, scenes, sensors, heating, garage doors, media players, cameras, alarms, and routines you use every day.
...
Start here: **[Choose your screen](/screens/)** or **[install Basalt](/getting-started/install)** if you already have one. For room controls, music, and cameras, browse the [practical guides](/guides/).

**Source code and issues:** [github.com/infamy/basalt](https://github.com/infamy/basalt).
...
Basalt includes card types for common Home Assistant controls and display-only information:
...
2. Install Basalt from your browser.
...
|---|---|---|
| 10.1-inch JC8012P4A1, original up to `2627` and new from `2628` rear case revisions | [AliExpress ~£40](https://www.aliexpress.com/item/1005008789890066.html) | [Stand page](/reference/3d-printable-stands) |
| 10.1-inch JC8012P4A1 V3 production-silicon panel | [AliExpress ~£40](https://www.aliexpress.com/item/1005008789890066.html) | [Stand page](/reference/3d-printable-stands) |
| 7-inch JC1060P470, V1 (unmarked case) and V2 (case marked `V2`) panel revisions | [AliExpress ~£40](https://www.aliexpress.com/item/1005010023056143.html) | [Stand page](/reference/3d-printable-stands) |
| 4.3-inch JC4880P443 | [AliExpress ~£24](https://www.aliexpress.com/item/1005009673625472.html) | [Stand page](/reference/3d-printable-stands) |
| 4-inch ESP32-P4 86 Panel | [AliExpress ~£45](https://www.aliexpress.com/item/1005009476605517.html) | [Stand page](/reference/3d-printable-stands) |
| 4-inch 4848S040 | [AliExpress ~£16](https://www.aliexpress.com/item/1005008214679682.html) | [Stand page](/reference/3d-printable-stands) |
