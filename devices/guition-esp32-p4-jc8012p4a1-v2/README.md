# Guition ESP32-P4 JC8012P4A1 V2 (10.1")

10.1-inch 1280x800 landscape touchscreen panel that runs Basalt firmware for Home Assistant. A fixed 5x4 grid of 20 configurable buttons lets you control lights, switches, fans, and other smart home devices with a single tap. The display also shows a live clock, indoor/outdoor temperature, and includes a screensaver with adjustable brightness.
