...
RELEASE_URL_BASE = "https://github.com/infamy/basalt/releases/tag/"
PROJECT_NAME = "infamy.basalt"
...
def cmd_recovery_manifest(args: argparse.Namespace) -> None:
    ...
    data = {
        ...
        # Basalt installation as an update rather than a different product.
        "name": "Espcontrol",
        "version": args.version,
        "home_assistant_domain": "esphome",
